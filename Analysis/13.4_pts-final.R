...
# # directory
pred_dir <- "Data/Outputs/2021_pred/prep_files/"
prep <- list.files(pred_dir, full.names = T)

# read in files individually
glm <- readRDS("Data/Outputs/2021_pred/RSF_output/20221024_2021_eHSF_output.rds")
avail <- readRDS(prep[4])
used <- read.csv(prep[2])
road <- read.csv(prep[1])
pdsi <- read.csv(prep[3])
...
# Save
saveRDS(fin, "Data/Outputs/2021_pred/prep_files/20221024_2021_files-combined.rds")
