...
## Load in data ----
# Test read
fin <- readRDS("Data/Outputs/2021_pred/prep_files/20221024_2021_files-combined.rds")
head(fin)
...
# Save
write.csv(fin2, "Data/Outputs/2021_pred/20221024_2021-10.5.csv", row.names = FALSE)
